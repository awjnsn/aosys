...
void cn_proc_configure(int sock_fd, bool enable)
{
    ...
    // FIXME: Initialize struct nlmsghdr, struct cn_msg, and struct
    // proc_cn_mcast_op
...
int main(int argc, char **argv)
{
    ...
    // FIXME: recv(2) data from the socket and iterate over nl message (see
    // netlink(7))
    // FIXME: For NLMSG_DONE messages, invoke cn_proc_handle on the (struct
    // proc_event*)cn_hdr->data
    return 0;
}
